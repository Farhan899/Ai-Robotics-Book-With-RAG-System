...
user: 
command: /sp.tasks
labels: [tasks,rag,chatbot,ai,backend]
links:
  spec: null
  ticket: null
  adr: null
...
I'll start by checking the prerequisites to get the feature directory and available documents:

## Outcome

- ✅ Impact: Created comprehensive task list for RAG chatbot implementation
- 🧪 Tests: Task list includes mandatory test-first approach per constitutional requirement
- 📁 Files: tasks.md created in specs/001-rag-chatbot/ with 50 detailed tasks
